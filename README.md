...
🔗 **Versão online do front-end:**
[https://projeto-ci-cd-front-gamma.vercel.app/](https://projeto-ci-cd-front-gamma.vercel.app/)
...
2. Após o deploy, abra o link público gerado pela Vercel — ou use diretamente o link já hospedado:
   **[https://projeto-ci-cd-front-gamma.vercel.app/](https://projeto-ci-cd-front-gamma.vercel.app/)**
...
4. Clique no botão **Testar API** para visualizar o retorno do servidor.
